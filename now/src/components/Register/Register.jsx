...
setIsLoading(true)
try {
 const res =  await axios.post(`https://ecommerce.routemisr.com/api/v1/auth/signup` , formValues)
...
const validation = Yup.object().shape({
    ...
    .matches(/^01[0125][0-9]{8}$/ , "Enter egyptain number"),
  });
 ...
 let formik = useFormik({
  ...
  <div className='py-6 mx-auto max-w-lg'>
    <h1 className='text-4xl text-green-600 font-bold mb-6'>Register Now :</h1>
